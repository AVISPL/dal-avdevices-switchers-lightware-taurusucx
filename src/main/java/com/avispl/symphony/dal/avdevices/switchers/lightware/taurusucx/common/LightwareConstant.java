...
public class LightwareConstant {
	...
	public static final String AUDIO_PERCENT_CURRENT_VALUE = "AudioAnalogOutput#VolumePercentCurrentValue(%)";
	...
	public static final String USB_HOST_OUTPUT = "H1";
	public static final String USB_HOST_PREFIX = "USBHost";
	public static final String USB_HUB = "USBHub#";
	public static final String CONNECTION_SOURCE = "ConnectedSource";
	public static final String CONNECTION_DESTINATION = "ConnectedDestinations";
	...
	public static final String INPUT_4 = "I4";
	public static final String USB_INPUT_1 = "U1";
	public static final String USB_INPUT_2 = "U2";
	public static final String USB_INPUT_3 = "U3";
	public static final String USB_INPUT_4 = "U4";
	public static final String USB_OUTPUT = "H1";
